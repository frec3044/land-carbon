...
Based on information about location and ecosystem type, rank the sites in order of 1 = most tree vegetation carbon per unit area, 4 = least tree vegetation carbon per unit area. Carbon per unit area is the average carbon the same area at each of the sites (e.g., m2 of land).  Describe the reasons why you choose the order.
