...
When you are finished pulling data from database, it is good practice to close it using the following code:
...
Potential issues with rendering:
  ...
  - You may have issues with you database connection when you render.  You can try running `dbDisconnect(con)` and/or restarting Rstudio.
