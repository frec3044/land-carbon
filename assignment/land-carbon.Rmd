...
**Question 2:** Add code to calculate the total tree carbon for each at each site
...
**Question 3:** Generate a figure showing the mean live tree carbon stocks in each site and year. You will have year on the axis and carbon stocks on the y-axis with different lines for each site. Be sure your figures are complete with units, labels, and a title.  Here is an example of the plot for a different set of sites.  
...
**Question 4:** Generate a table of values for the site level carbon stocks averaged across years and plots (I recommend using the `kable()` function to generate a clean looking table).
...
**Question 5:** Describe any issues that you had with your analysis, concerns you have with your analysis, and concerns you have with the data.

**Answer 5:**
  
**Question 6:** Describe whether your data analysis supported your hypothesis from Part #1 and, if not, possible reasons why it did not.
